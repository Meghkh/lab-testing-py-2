...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        db.create_all()
        example_data()
        # PAUSE after example_data to check in psql that testdb works
        # press c to continue - never leave this debugger statement in your code
    ...
    def test_games(self):
        ...
        self.assertIn("better card game", result.data)
